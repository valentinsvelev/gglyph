...
```{r example_glyphs_base, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
...
```{r example_glyphs_diff_num_nodes, fig.width=8, fig.height=10, fig.retina=10}
plot_list <- list()
...
```{r example_glyphs_fill, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
...
```{r example_glyphs_outline, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r example_glyphs_size, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r example_glyphs_alpha, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r example_glyphs_shape, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
In addtion, the size of the labels can be changed:

```{r example_glyphs_labels, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r example_glyphs_legend, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r example_glyphs_additional, fig.width=8, fig.height=6, fig.retina=10}
# Non-grouped
ggplot(data = mock_data) +
  geom_glyph(
    node_colour = "black",
...
```{r glyphs_pisa_base, fig.width=8, fig.height=6, fig.retina=10}
...
```{r glyphs_sipri_base, fig.width=8, fig.height=6, fig.retina=10}
...
```{r glyphs_pisa_polished, fig.width=8, fig.height=6, fig.retina=10}
ggplot(data = processed_data_pisa) +
  geom_glyph(
    node_colour = "black",
    edge_colour = "orange"
...
```{r glyphs_sipri_polished, fig.width=8, fig.height=6, fig.retina=10}
ggplot(data = processed_data_sipri) +
  geom_glyph(
    node_colour = "black",
    node_fill = "purple",
